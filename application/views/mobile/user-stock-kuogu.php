        ...
        <div class="circle-half-bg">
          ...
          <div class="trading-pages-box mt15">
            <div class="bd">
              <ul class="trade-input">
                ...
                <li class="tit">增加注册资本：</li>
                <li class="cont turn">
                  <div class="left">
                    <input type="text" name="" value="" id=""><span>万元/人民币</span>
                  </div>
                  <div class="right"><i class="ico-turn"></i>20%</div>
                </li>
                <li class="tip">
                  <p class="after-cls"><em class="col-f4364c in-block fl-l">手续费400元</em><em class="col-f4364c in-block fl-r">预计融资2,994,440元</em></p>
                </li>
          ...
          <div class="lh34 mt5 mb5 col-base f16 pl15 pr15">选择以下支付方式</div>
            <div class="trading-pages-box pl0 pr0">
              ...
              <p class="ta-c mb25">
                <a href="/mobile/user-stock-kuogu-tj.php" class="btn-default">提交，发布股权交易</a>
              </p>
            </div>
          </div>
